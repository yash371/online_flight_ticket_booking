  ...
  return (
    <CustomKeyboardView>
        ...
        <View style={styleFile.container}>
           <H1 style={{marginTop:80}}>Sign Up</H1>
           ...
           <CustomeAuthButton text={"Sign In"} onPress={handleRegister} />
           <View style={{alignItems:'center'}}>
           <P style={{marginTop:20}}>Or Sign Up With</P>
           </View>
           ...
           <Pressable onPress={()=>router.push('signIn')}><P style={{color:"#0064D2"}}>Sign In</P></Pressable>
           </View>
        </View>
    </CustomKeyboardView>
  )
